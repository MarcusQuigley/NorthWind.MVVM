...
namespace MyNew.Northwind.UI.WPF
{
    static class ListBoxBehaviors
    {
        ...
        private static void ListBox_DoubleClick(object sender, RoutedEventArgs routedEventArgs)
        {
